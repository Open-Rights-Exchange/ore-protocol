...
class Test1(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        instrold_deploy = eosf.account(account_master, name="instr.old")
        wallet.import_key(instrold_deploy)
        assert(not instrold_deploy.error)
        ...
        global instr_ore
        instr_ore = eosf.Contract(instr_deploy, contractPath+"/old.instrument")
